...
const caps = {
  ...
  "browserstack.username": process.env.BROWSERSTACK_USERNAME || "[Add your username here]",
  "browserstack.accessKey":
    process.env.BROWSERSTACK_ACCESS_KEY || "[Add your access key here]",
...
exports.BS_LOCAL_ARGS = {
  key: process.env.BROWSERSTACK_ACCESS_KEY || "[Add your access key here]",
};
...
const patchMobileCaps = (name, title) => {
  ...
  caps.deviceName = deviceName ? deviceName : "Samsung Galaxy S22";
  caps.osVersion = osVersion ? osVersion : "13.0";
  caps.name = title;
